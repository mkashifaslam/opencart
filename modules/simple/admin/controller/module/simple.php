...
class ControllerModuleSimple extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('simple', $this->request->post);		
		...
		if (isset($this->request->post['simple_module'])) {
			$this->data['modules'] = $this->request->post['simple_module'];
		} elseif ($this->config->get('simple_module')) { 
			$this->data['modules'] = $this->config->get('simple_module');
		}	
